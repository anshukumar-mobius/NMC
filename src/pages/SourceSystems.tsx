  ...
  const mockSystems: SourceSystem[] = [
    {
      ...
      examples: ['InterSystems TrakCare', 'Epic', 'MEDITECH', 'Cerner Millennium', 'Custom EMRs'],
      connectionType: 'HL7',
      securityLevel: 'High',
      complianceStandards: ['HIPAA', 'UAE DPA', 'JCI', 'MOHAP'],
    ...
    },
    {
      ...
      examples: ['Sunquest', 'Cerner PathNet', 'LabWare'],
      connectionType: 'HL7',
      securityLevel: 'High',
      complianceStandards: ['CAP', 'ISO 15189', 'UAE MOH', 'JCI'],
    ...
    },
    {
      ...
      examples: ['GE Centricity', 'Philips IntelliSpace', 'Fuji Synapse'],
      connectionType: 'FHIR',
      securityLevel: 'High',
      complianceStandards: ['DICOM', 'ACR', 'UAE Radiology Standards'],
    ...
    },
    {
      ...
      examples: ['Mediware', 'BD Pyxis', 'Omnicell', 'EMR modules'],
      connectionType: 'HL7',
      securityLevel: 'High',
      complianceStandards: ['USP 797', 'JCI Medication Standards', 'UAE Pharmacy Law'],
    ...
    },
    {
      ...
      examples: ['Quantros QCMS', 'RLDatix', 'JCI/NABIDH templates'],
      connectionType: 'REST API',
      securityLevel: 'Medium',
      complianceStandards: ['JCI', 'NABIDH', 'ISO 9001', 'MOHAP Quality Standards'],
    ...
    },
    {
      ...
      examples: ['Oracle Health RCM', 'SAP IS-H', 'Cerner RevWorks'],
      connectionType: 'Database',
      securityLevel: 'High',
      complianceStandards: ['PCI DSS', 'UAE Insurance Law', 'ADNIC/DAMAN Standards'],
    ...
    },
    {
      ...
      examples: ['NABIDH APIs (Dubai)', 'Riayati (Abu Dhabi)', 'ADHICS specs'],
      connectionType: 'REST API',
      securityLevel: 'High',
      complianceStandards: ['NABIDH', 'ADHICS', 'UAE National Health Data Standards'],
    ...
    },
    {
      ...
      examples: ['Philips IntelliVue', 'Mindray BeneVision', 'GE MUSE'],
      connectionType: 'Real-time',
      securityLevel: 'High',
      complianceStandards: ['IEC 60601', 'FDA 510(k)', 'CE Marking', 'UAE Medical Device Standards'],
    ...
    },
    {
      ...
      examples: ['RLDatix', 'Datix CloudIQ'],
      connectionType: 'REST API',
      securityLevel: 'Medium',
      complianceStandards: ['JCI Patient Safety Goals', 'WHO Patient Safety', 'UAE Patient Safety Standards'],
    ...
    },
    {
      ...
      examples: ['Part of EMR or Oracle Healthcare'],
      connectionType: 'HL7',
      securityLevel: 'High',
      complianceStandards: ['HL7 ADT Standards', 'UAE Healthcare Licensing', 'JCI Access Standards'],
    ...
    },
    {
      ...
      examples: ['SAP SuccessFactors', 'Oracle HR', 'Bespoke HRMS'],
      connectionType: 'Database',
      securityLevel: 'High',
      complianceStandards: ['UAE Labor Law', 'DHA Licensing', 'JCI Human Resources Standards'],
